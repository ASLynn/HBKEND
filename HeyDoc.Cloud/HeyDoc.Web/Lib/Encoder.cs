...
namespace HeyDoc.Web.Lib
{
    public class Encoder
    {
        ...
        protected const string MainWheel = "Y2CXB8E4FAHVTDWZPSKUJNLG3596Q7RM";
        protected const string InitialWheel = "RC4XBJH9W6ST82VFELQGZNDKY3M5UP7A";
        ...
        public static string Conceal(long value)
        {
            string base32value = IntToBase32(value);
            base32value = base32value.PadLeft(7, 'A'); // all results should have at least 5 chars
        ...
        public static long Reveal(string encodedValue)
        {
        ...
        public static string IntToBase32(long input)
        {
            return ConvertToBase(input, Base32Alphabet);
        }

        public static long Base32ToInt(string input)
        {
            return ConvertFromBase(input, Base32Alphabet);
        }

        public static string ConvertToBase(long input, string baseAlphabet)
        {
            string result = "";
            ...
            else
            {
                while (input > 0)
                {
                    ...
                    int remainder = (int)(input % baseAlphabet.Length);
                    result = baseAlphabet[remainder] + result;
        ...
        public static long ConvertFromBase(string input, string baseAlphabet)
        {
